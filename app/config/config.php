<?php   
    ...
    defined('APP_DEFAULT_LANG')         ? null : define ('APP_DEFAULT_LANG', 'en');


    // session config
    defined('SESSION_NAME')             ? null : define ('SESSION_NAME', '_E_STORE_SESSION');
    ...
    //check acess for priveleges if  equels 1 enables the privelges sysytem else 0 not enabled
