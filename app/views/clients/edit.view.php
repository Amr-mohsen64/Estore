        ...
        <legend class='primary-color'><?= @$text_header?></legend>
            <div class="row flex-row-reverse mt-4">
                <div class="col-lg-3">
                    <div class="form_wrap">
                        <div class="input_wrap form-group">
                            <input type="text" name = 'Name' value = '<?= $this->showValue('Name' , $client) ?>'  required/>
                ...
                <div class="col-lg-3">
                    <div class="form_wrap">
                        <div class="input_wrap form-group">
                            <input type="email" name = 'Email'  value = '<?= $this->showValue('Email' ,$client) ?>' required/>
                ...
                <div class="col-lg-3">
                    <div class="form_wrap">
                        <div class="input_wrap form-group">
                            <input type="text" name = 'PhoneNumber'  value = '<?= $this->showValue('PhoneNumber' ,$client) ?>' required/>
                ...
                <div class="col-lg-3">
                    <div class="form_wrap">
                        <div class="input_wrap form-group">
                            <input type="text" name = 'Address'  value = '<?= $this->showValue('Address' ,$client) ?>' required/>
