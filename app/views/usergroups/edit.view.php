                ...
                <?php if($privilegs !== false) : foreach ($privilegs as $privilege) : ?>
                    <div class="col-lg-12">
                        <div class="form-check form-check">
                            <input class="form-check-input" name = 'privileges[]' type="checkbox" id="<?= $privilege->PrivilegeTitle ?>" value="<?= $privilege->PrivilegeId?>" <?= in_array($privilege->PrivilegeId , $groupPrivileges) ? 'checked' : ' ' ?>>
